      ...
      <div className="mb-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white transition-colors duration-200 outline-emerald-500 focus:ring-2 focus:ring-emerald-500"
          />
          {searchTerm && (
            <button
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center">
            <FiFilter className="w-5 h-5 text-emerald-600 dark:text-emerald-400 mr-2" />

...
const TrainerCancelSessionModal = ({
  isModalOpen,
  session,
  handleCloseModal,
  onSuccess,
  ...
  const handleCancel = async () => {
    try {
      ...
      await trainerService.cancelMySession(session._id, cancellationReason);
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-700 dark:text-red-400 mt-1">
                      Once cancelled, the client will be notified and the
                      session will need to be rescheduled if required.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Please tell us why you're cancelling this session..."
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    This will be shown to your client
                  </p>
                </div>
...
export default TrainerCancelSessionModal;

  ...
  if (sessions.length === 0) {
    return (
      <motion.div
        ...
        className="w-full text-center py-16 bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700"
      >
  ...
  return (
    <div className="w-full">
      <motion.div
        ...
        className="w-full bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden"
      >
          ...
          <table className="w-full table-auto">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {sessions.map((session, index) => (
                ...
                >
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300 whitespace-nowrap overflow-hidden text-ellipsis">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300 whitespace-nowrap overflow-hidden text-ellipsis">
                    <div className="flex items-center gap-2">
                      <FiUser className="w-4 h-4 text-emerald-600 flex-shrink-0" />
                      <span className="truncate">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300 overflow-hidden">
                    <div className="flex items-center gap-2">
                      {session.trainer?.specializations &&
                      session.trainer.specializations.length > 0 ? (
                        <span className="inline-flex items-center gap-1">
                          <span className="px-2 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded-full text-xs truncate">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300 overflow-hidden">
                    {session.notes ? (
                      <span className="block truncate">{session.notes}</span>
                    ) : (
        ...
        {pagination.totalPages > 1 && (
          <div className="w-full px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">

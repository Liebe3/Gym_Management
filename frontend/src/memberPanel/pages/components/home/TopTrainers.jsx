...
const TopTrainers = ({ trainers, onViewProfile }) => {
        ...
        >
          ...
          <div className="flex gap-2 pt-2 border-t border-gray-300 dark:border-gray-600">
            <motion.button
              ...
              className="w-full px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium rounded-lg transition-colors flex items-center justify-center gap-1 cursor-pointer"
            >
